 ...
 */
    ...
    public:
        ...
        static constexpr mdc::DSpan<mdc::SpanSize::Index<Value>> index() {
            return mdc::DSpan<mdc::SpanSize::Index<Value>>{};
        }
         ...
         */
        static constexpr mdc::Span index(std::size_t value) {
            return mdc::Span{value};
        }
        ...
        static constexpr mdc::DSpan<mdc::SpanSize::Interval<From, To>> interval() {
            return mdc::DSpan<mdc::SpanSize::Interval<From, To>>{};
        }
        ...
        static constexpr mdc::DSpan<mdc::SpanSize::Interval<Size>> interval(std::size_t from, std::size_t to) {
            return mdc::DSpan<mdc::SpanSize::Interval<Size>>{from, to};
        }
         ...
         */
        static constexpr mdc::Span interval(std::size_t from, std::size_t to) {
            return mdc::Span{from, to};
        }
         ...
         */
        static constexpr mdc::DSpan<mdc::SpanSize::All> all() {
            return mdc::DSpan<mdc::SpanSize::All>{};
        }
    };
